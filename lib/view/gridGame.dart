...
class GridGameState extends State<GridGame> {
            ...
            Row(
              ...
              children: [
                GestureDetector(
                    onTap: () {
                      print("case00");
                      if (widget.state.case00 != null ||
                          widget.state.state != GameStateStatus.play) return;
                      setState(() {
                        widget.state.case00 =
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case00 != null
                            ? (widget.state.case00!
                ...
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case01 != null
                            ? (widget.state.case01!
                                ? widget.state.player1.icon
                                : widget.state.player2.icon)
                            : null)),
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case02 != null
                            ? (widget.state.case02!
                                ? widget.state.player1.icon
                                : widget.state.player2.icon)
                            : null))
                ...
                children: [
                  GestureDetector(
                      ...
                      child: Container(
                          ...
                          width: size.height / 7,
                          color: Colors.white,
                          child: widget.state.case10 != null
                              ? (widget.state.case10!
                                  ? widget.state.player1.icon
                                  : widget.state.player2.icon)
                              : null)),
                  GestureDetector(
                      ...
                      child: Container(
                          ...
                          width: size.height / 7,
                          color: Colors.white,
                          child: widget.state.case11 != null
                              ? (widget.state.case11!
                                  ? widget.state.player1.icon
                                  : widget.state.player2.icon)
                              : null)),
                  GestureDetector(
                      ...
                      child: Container(
                          ...
                          width: size.height / 7,
                          color: Colors.white,
                          child: widget.state.case12 != null
                              ? (widget.state.case12!
                                  ? widget.state.player1.icon
                                  : widget.state.player2.icon)
                              : null))
              ...
              children: [
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case20 != null
                            ? (widget.state.case20!
                                ? widget.state.player1.icon
                                : widget.state.player2.icon)
                            : null)),
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case21 != null
                            ? (widget.state.case21!
                                ? widget.state.player1.icon
                                : widget.state.player2.icon)
                            : null)),
                GestureDetector(
                    ...
                    child: Container(
                        ...
                        width: size.height / 7,
                        color: Colors.white,
                        child: widget.state.case22 != null
                            ? (widget.state.case22!
                                ? widget.state.player1.icon
                                : widget.state.player2.icon)
                            : null))
  ...
  checkIfWin() {
    ...
    if (widget.state.numberMovePlay == 8) {
